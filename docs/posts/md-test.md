...
***
#### Syntax Highlighting
In your fenced block, add an optional language identifier and we'll run it through syntax highlighting (~~[Support Languages](https://github.com/github/linguist/blob/master/lib/linguist/languages.yml)~~ [Docsify docs](https://docsify.js.org/#/language-highlight)).
...
Code:
    ...
    ![Alt text](https://www.kernel.org/theme/images/logos/tux.png)

    ![Alt text](https://www.kernel.org/theme/images/logos/tux.png "Optional title")
Preview:
***
![Alt text](https://www.kernel.org/theme/images/logos/tux.png)
...
Code:
    ...
    [img id]: https://www.kernel.org/theme/images/logos/tux.png  "Optional title attribute"
    ![Alt text][img id]
Preview:
***
[img id]: https://www.kernel.org/theme/images/logos/tux.png  "Optional title attribute"
